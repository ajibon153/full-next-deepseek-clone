...
const Sidebar = ({ expand, setExpand }: { expand: boolean; setExpand: (v: boolean) => void }) => {
    ...
    return (
        <div
            className={`flex flex-col justify-between bg-[#212327] pt-7 transition-all z-50 max-md: relative max-md: h-screen ${expand ? "p-4 w-64" : "md:w-20 w-0 max-md:overflow-hidden"}`}
        >
            <div>
                <div className={`flex ${expand ? "flex-row gap-10" : "flex-col items-center gap-8"}`}>
                    ...
                    >
                        ...
                        />
                        <div
                            className={`absolute w-max ${expand ? "left-1/2 -translate-x-1/ 2 top-12" : "-top-12 left-0"} opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-1g shadow-lg pointer-events-none`}
                        >
            ...
            <div>
                ...
                >
                    ...
                    >
                        <div className="relative w-max bg-black text-white text-sm p-3 rounded-1g shadow-lg">
